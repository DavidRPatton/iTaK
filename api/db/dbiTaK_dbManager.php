...
function getConnection() {
	...
	global $db_iTaK_db_Url, $db_iTaK_db_User, $db_iTaK_db_Pass, $db_iTaK_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_iTaK_db_Url.";dbname=".$db_iTaK_db_DbName, $db_iTaK_db_User, $db_iTaK_db_Pass);
